...
export const ACTION_LABELS: Record<string, string> = {
  ...
  'invoice.fee_added': 'Fee added to invoice',
  'invoice.receipt_sent': 'Receipt sent',
  'discount.requested': 'Discount requested',
  'discount.auto_approved': 'Discount auto-approved (below threshold)',
  ...
  'student.opt_out_overage_resolved': 'Opted out (overage resolved)',
  ...
  'school.phone_verified': 'Office phone confirmed',
